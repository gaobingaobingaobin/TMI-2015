function [  ] = plot_bar_graphs(parameter_values, error_opt_array, error_const_array, error_RF_compensated_array, error_T1_effective_array, error_SNR_array, berkeley_colors, xaxis_labels, axis_limits)

bc = berkeley_colors([2 4 1 6 3], :); 
for k=1:size(parameter_values, 1) 
    ...
    h_bar_graph = bar(parameter_values(k, :),  ...
        ...
        error_SNR_array(k, :)./error_opt_array(k, :); 
