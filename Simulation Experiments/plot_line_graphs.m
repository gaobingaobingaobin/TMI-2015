function [  ] = plot_line_graphs(parameter_values, error_opt_array, error_const_array, error_RF_compensated_array, error_T1_effective_array, berkeley_colors, xaxis_labels, axis_limits, axis_type)

for k=1:size(parameter_values, 1) 
    
    figure
    set(gca,'ColorOrder', berkeley_colors([2 4 1 3], :), 'NextPlot', 'replacechildren')
