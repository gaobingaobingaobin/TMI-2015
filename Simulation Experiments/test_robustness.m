function [ kPL_error_opt, kPL_error_const, kPL_error_RF_compensated, kPL_error_T1_effective] = test_robustness(model, parameter_to_vary, parameter_values, num_trials, thetas_opt, thetas_const, thetas_RF_compensated, thetas_T1_effective, kTRANS_val, kPL_val, R1P_val, R1L_val, u_est, sigma_squared )
...
%   assuming that parameter_values(i) is the true value of parameter
    syms R1P R1L kPL kTRANS input_scale sigma_2 t0
    ...
    for param_count = 1:length(parameter_values)
        ...
        var_initial = [ kPL_val, R1P_val, R1L_val, u_est', u_est', u_est', u_est']; 
    ...
    % for param_count = 1:length(parameter_values) 
        ...
        obj = @(var) joint_least_squares_4flipangles(var(1:3), known_parameters, sigma_squared, ...
            thetas_opt, thetas_const,  thetas_RF_compensated, thetas_T1_effective, ...
