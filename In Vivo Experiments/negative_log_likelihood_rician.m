function [ l1 ] = negative_log_likelihood_rician(parameters, known_parameters, noise_level, Pi, alpha1, z1, u1)
    ...
    y1 = trajectories_2param(parameters, known_parameters, Pi, alpha1, u1)';
